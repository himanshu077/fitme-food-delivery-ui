                        ...
                        <Box className="!flex !justify-between ">
                            <Box>
                                <Box className="!flex !flex-row !gap-2">
                                    ...
                                    <Text className="!text-base Poppins500 !text-white !pt-[1px]">4.0</Text>
                                </Box>
                                <Text className="Poppins500 !text-base !text-white">100+ ratings</Text>
                            </Box>
                            <Divider orientation='vertical' className="!border-l-white !border-l" />
                            <Box>
                                <Text className="Poppins500 !text-base !text-white !text-center">30 Mins</Text>
                                <Text className="Poppins500 !text-base !text-white !text-center">Delivery Time</Text>
                            </Box>
                            <Divider orientation='vertical' className="!border-l-white !border-l" />
                            <Box>
                                <Text className="Poppins500 !text-base !text-white !text-center">₹200</Text>
                                <Text className="Poppins500 !text-base !text-white !text-center">Cost for two</Text>
                            </Box>
                        </Box>
                    </Box>
                    <Box className="!border-dashed !border-2 !p-5 lg:!ml-24 lg:!mt-16 !rounded-[20px] !border-[--saffron-400]">
